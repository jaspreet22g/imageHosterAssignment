...
public class UserController {
  ...
  public String registerUser(User user, Model model) {boolean validPassword = checkValidPassword(user.getPassword());
    if (validPassword) 
    {
  ...
  private boolean checkValidPassword(String password) {
    ...
    if (Pattern.matches(letterPattern, password) && Pattern.matches(digitPattern, password)&& Pattern.matches(otherCharPattern, password)) 
      return true;
    else
        return false;
  }
